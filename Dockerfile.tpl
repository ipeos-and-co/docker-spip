...
LABEL org.opencontainers.image.description="SPIP %%SPIP_VERSION%% CMS on PHP %%PHP_VERSION%% / Apache"
LABEL org.opencontainers.image.source="https://github.com/ipeos-and-co/docker-spip"
LABEL org.opencontainers.image.licenses="GPL-3.0-only"
LABEL org.opencontainers.image.version="%%SPIP_PACKAGE%%"
...
RUN set -eux; \
	...
	\
	git clone --depth 1 --branch %%SPIP_CLI_VERSION%% https://git.spip.net/spip-contrib-outils/spip-cli.git /opt/spip-cli; \
	...
	echo "%%SPIP_SHA256%% *spip.zip" | sha256sum -c -; \
	unzip -q spip.zip -d /usr/src/spip; \
	rm spip.zip; \
